...
```
One install brings the whole suite (7 skills + 9 commands: `/omg` + 8 `/omg:*`). There are no separate/optional plugins to add. It copies the Ouroboros wrapper surfaces only; it does not install Ouroboros.
